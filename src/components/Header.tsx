    ...
    return (
        <>
            ...
            <div className='header__seen-on--logos'>
                <img src={BBC} alt='' className='header__seen-on--item' />
                <img src={Forbes} alt='' className='header__seen-on--item' />
                <img src={Techcrunch} alt='' className='header__seen-on--item' />
                <img src={BusinessInsider} alt='' className='header__seen-on--item' />
            </div>
        </>
    )
}
